...
CREATE TABLE `y_info` (
  ...
  `bednum` varchar(45) DEFAULT '' COMMENT '床位数量',
  `score` varchar(45) DEFAULT '' COMMENT '评分',
  `field_welcome` varchar(200) DEFAULT '' COMMENT '欢迎词\n',
  `field_description` varchar(200) DEFAULT '' COMMENT '机构简介',
  `field_money` varchar(200) DEFAULT '' COMMENT '收费标准',
  `field_eat` varchar(200) DEFAULT '' COMMENT '饮食标准\n',
  `field_medical` varchar(200) DEFAULT '' COMMENT '医疗条件\n',
  `field_live` varchar(200) DEFAULT '' COMMENT '入住须知\n',
  `field_service` varchar(200) DEFAULT '' COMMENT '服务指南',
  `field_coupon` varchar(200) DEFAULT '' COMMENT '优惠信息',
  `field_address` varchar(200) DEFAULT '' COMMENT '地理位置',
  `field_contact` varchar(200) DEFAULT '',
  `field_rome` varchar(200) DEFAULT '' COMMENT '房间设置',
  `telephone` varchar(45) DEFAULT '' COMMENT '联系电话',
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `y_info` VALUES (1,'b5eeb9e9f84942ac9496e50acde73fb3','333','','','32510001,32510002,32510003','','','','','','','','','','','','','','','');
...
) ENGINE=InnoDB AUTO_INCREMENT=3074 DEFAULT CHARSET=utf8 COMMENT='数据列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=398 DEFAULT CHARSET=utf8 COMMENT='数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zweb_fields` (
  ...
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=705 DEFAULT CHARSET=utf8 COMMENT='视图字段表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zweb_options` (
  ...
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8 COMMENT='操作表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zweb_view` (
  ...
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='视图表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-06-01 22:30:35
