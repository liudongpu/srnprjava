...
CREATE TABLE `y_info` (
  ...
  `field_coupon` varchar(1000) DEFAULT '' COMMENT '优惠信息',
  `field_welcome` varchar(1000) DEFAULT '' COMMENT '欢迎词\n',
  `field_description` varchar(4000) DEFAULT '' COMMENT '养老院简介',
  `field_live` varchar(2000) DEFAULT '' COMMENT '入住须知\n',
  `field_service` varchar(2000) DEFAULT '' COMMENT '服务指南',
  ...
  `field_eat` varchar(4500) DEFAULT '' COMMENT '一 周食谱',
...
) ENGINE=InnoDB AUTO_INCREMENT=3201 DEFAULT CHARSET=utf8 COMMENT='数据列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zweb_fields` (
  ...
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=863 DEFAULT CHARSET=utf8 COMMENT='视图字段表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-06-02  2:50:12
