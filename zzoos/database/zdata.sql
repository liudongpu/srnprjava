...
INSERT INTO `user_info` VALUES (8,'6786149106e4466d96470ccd54d9b7b6','s','s','s5@ss.ss','2013-05-03 23:51:56','012b2a0a3c4c48afa0181bf7df0fac90','33','');
...
) ENGINE=InnoDB AUTO_INCREMENT=3000 DEFAULT CHARSET=utf8 COMMENT='数据列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zweb_fields` (
  ...
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=575 DEFAULT CHARSET=utf8 COMMENT='视图字段表';
/*!40101 SET character_set_client = @saved_cs_client */;
