...
) ENGINE=InnoDB AUTO_INCREMENT=3039 DEFAULT CHARSET=utf8 COMMENT='数据列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zweb_fields` (
  ...
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=684 DEFAULT CHARSET=utf8 COMMENT='视图字段表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-05-20  0:53:45
