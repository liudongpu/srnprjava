...
--
-- Current Database: `zdata`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `zdata` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `y_info` (
  ...
  `money_cid` int(11) DEFAULT '0' COMMENT '价格范围',
  `peopletype_cid` int(11) DEFAULT '0' COMMENT '老人的情况\n',
...
INSERT INTO `y_menu` VALUES (1,'','413001','银杏林后台菜单','',1,'413'),(2,'','413001001','功能列表','',2,'413001'),(3,'','413001002','系统设置','',2,'413001'),(4,'','413001001001','养老院维护','chart-system_table',3,'413001001'),(5,'','413001001002','广告设置','',3,'413001001');
...
) ENGINE=InnoDB AUTO_INCREMENT=3102 DEFAULT CHARSET=utf8 COMMENT='数据列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-05-31  2:11:28
