...
CREATE TABLE `zweb_options` (
  ...
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8 COMMENT='操作表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'zdata'
--
...
-- Dump completed on 2013-05-20 22:13:55
