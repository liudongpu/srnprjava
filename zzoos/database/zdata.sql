...
INSERT INTO `user_info` VALUES (8,'6786149106e4466d96470ccd54d9b7b6','s','s','s5@ss.ss','2013-05-03 23:51:56','012b2a0a3c4c48afa0181bf7df0fac90','33',''),(9,'6371c752ba6d450db3d67650beed0390','srnpr@sina.com','s','srnpr@sina.com','2013-05-11 15:35:42','057c948698344f42af11ae1957054c5e','','srnpr');
...
CREATE TABLE `zweb_fields` (
  ...
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=576 DEFAULT CHARSET=utf8 COMMENT='视图字段表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zweb_options` (
  ...
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COMMENT='操作表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zweb_view` (
  ...
  PRIMARY KEY (`zid`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='视图表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-05-11 17:06:08
