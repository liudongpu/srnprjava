		...
		<div class="img_body">
			...
			<div class="img_main">
				<div class="c_left">
					...
					<#assign images_last=pageexec.upDataOneQuery("info_images","uid<:uid","uid",pageinfo.getWebSet()["Url_Option"])?default("")>
				...
				<div class=c_right>
					<div class="c_nav">
					<#assign images_next=pageexec.upDataOneQuery("info_images","uid>:uid","uid",pageinfo.getWebSet()["Url_Option"])?default('')>
